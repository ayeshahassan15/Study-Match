...
module.exports = async (req, res) => {
  ...
  try {
    if (req.method === "POST" && url.includes("register")) return await authController.register(req, res);
    if (req.method === "POST" && url.includes("login")) return await authController.login(req, res);
    if (req.method === "GET" && url.includes("me")) return await authController.getMe(req, res);
    if (req.method === "PATCH" && url.includes("update")) return await authController.update(req, res);
